...
>>>>>>> 4dd7dfe2d6c4fd9a93fe3b8d411b1f16174f8fb0
...
CREATE TABLE `product`  (
                            ...
                            `count` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '数量',
                            `unit` tinyint(1) UNSIGNED NULL DEFAULT 1 COMMENT '单位 1---k 2--pcs',
...
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES (1, 'jwco', '100V100UF', '10x20', 2, 1, 1, 1, '5.0', 0, '2023-02-17 21:00:46', NULL);
INSERT INTO `product` VALUES (2, '123', '123123', '123', 12, 2, 0, 0, '123', 1, '2023-02-17 22:56:53', NULL);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '张海升', '1eae7668d42053970a90c2c4d5af60fd', 1676696046, 1, 1);
